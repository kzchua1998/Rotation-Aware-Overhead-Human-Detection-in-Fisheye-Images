...
if __name__ == '__main__':
    ...
    if args.dataset == 'COCO':
        train_img_dir = r'D:\dataset\Terminal_ready\coco_json\images\train'
        #assert 'COCO' in train_img_dir # issue #11
        train_json = r'D:\dataset\Terminal_ready\coco_json\annotations\train\train.json'
        val_img_dir = r'D:\dataset\Terminal_ready\coco_json\images\validation'
        val_json = r'D:\dataset\Terminal_ready\coco_json\annotations\validation\val.json'
    ...
    # added from here
        ...
        train_img_dir = r"D:/visual_studio_code/RAPiD/dataset/train/image"
        train_json = r"D:\visual_studio_code\RAPiD\coco_json\unified.json"
        val_img_dir = r"D:/visual_studio_code/RAPiD/dataset/validation/image"
        val_json = r"D:\visual_studio_code\RAPiD\coco_json\unified.json"
        lr_SGD = 0.0001 / batch_size / subdivision
        # Learning rate setup
        def burnin_schedule(i):
            burn_in = 500
